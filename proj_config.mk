...
ifeq ($(origin CONFIG_DEVICE_ID), undefined)
$(warning ****** Please set CONFIG_DEVICE_ID, defaulting to 1 ******)
CFLAGS += -DDEVICE_ID=1
else
CFLAGS += -DDEVICE_ID=${CONFIG_DEVICE_ID}
endif

CFLAGS += -DWITH_ADC=1
#CFLAGS += -DLIGHT_SENSOR=1
#CFLAGS += -DLOUDNESS_SENSOR=1
CFLAGS += -DDHT22=1
